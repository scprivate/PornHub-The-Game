...
void HideCursor()
{
    ...
    void powrotdrzwi()
                                ...
                                cout<<endl<<PL("za tobπ znajdujπ siÍ drzwi do innego mieszkania.")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
              ...
              case 1: //Gorzki
                     ...
                     int napwn;
                            ...
                            if(napwn=='2')//wybÛr g≥Ûwny
                            {
                                ...
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<endl<<PL("Jesteú w úrodku. Zdejmujesz buty, przychodzi Ala i chcÍ siÍ przywitaÊ.")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 11);
                                ...
                                cout<<"2. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Witasz siÍ ale nie odzywasz.")<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"3. ";
                                SetConsoleTextAttribute(kolor, 8);
                                ...
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<endl<<PL("Wolnym krokiem pokonujesz stopieÒ po stopniu.");
                                cout<<endl<<PL("Gdy nagle uúwiadamiasz sobie øe tam nic nie ma.");
                                ...
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Przecieø sam to wprowadzi≥eú bez naszej zgody.");
                                SetConsoleTextAttribute(kolor, 2);
                                cout<<endl<<PL("Narrator: ");
                                SetConsoleTextAttribute(kolor, 8);
                                ...
                                cout<<endl<<PL("Gorzki: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Gdzie ja kurwa idÍ?")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------"<<endl;
                                SetConsoleTextAttribute(kolor, 11);
                                cout<<"Co robisz?"<<endl;
                                ...
                                cout<<endl<<PL("2. ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Tak wiesz øe musisz tam wrÛciÊ.");
                                wyborgorzky2=getch();
                                switch(wyborgorzky2)
                                {
                                case '1'://wybÛr 2.1
                                ...
                                cout<<endl<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("To co, ile bÍdziesz pi≥?")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------"<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"1. ";
                                ...
                                cout<<"3. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Jakoú tak wysz≥o, a ty ile pijesz?")<<endl;
                                wyborgorzky4=getch();
                                switch(wyborgorzky4)
                                ...
                                cout<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Dobra ja juø nic nie mÛwiÍ")<<endl;
                                cout.width(80);
                                SetConsoleTextAttribute(kolor, 7);
                                cout<<endl<<PL("Micha≥ zapamiÍta to!")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------"<<endl;
                                SetConsoleTextAttribute(kolor, 11);
                                ...
                                cout<<"3. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Kierujesz siÍ do drzwi za tobπ.")<<endl;
                                break;
                                    }
                                    case '2'://3.1.2
                                        {
                                ...
                                cout<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Moøe jedna flaszeczka nie wiem jeszcze.")<<endl;
                                SetConsoleTextAttribute(kolor, 4);
                                cout<<PL("Gorzki: ");
                                SetConsoleTextAttribute(kolor, 8);
                                ...
                                cout<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Jasne, pewnie skoÒczysz jak Puma rok temu na majÛwie.")<<endl<<endl;
                                cout<<"--------------------------------------------------------------------------------"<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"1. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Pierdol siÍ.")<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"2. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("* åmiejesz siÍ *")<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"3. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Jo albo jak ty u Ali w maju w tamtym roku.")<<endl;
                                wyborgorzky8=getch();
                                switch(wyborgorzky8)
                                {
                                case '1'://wybÛr 3.2.1
                                ...
                                cout<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("* Spoglπda na ciebie z lekkπ nienawiúciπ *")<<endl;
                                cout.width(80);
                                SetConsoleTextAttribute(kolor, 7);
                                cout<<endl<<PL("Micha≥ zapamiÍta to!")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                ...
                                cout<<endl<<PL("Gorzki: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Stary najebie siÍ w chuj.")<<endl;
                                SetConsoleTextAttribute(kolor, 11);
                                cout<<PL("Micha≥: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("* Spoglπda na ciebie ze zdziwieniem *")<<endl;
                                cout.width(80);
                                SetConsoleTextAttribute(kolor, 7);
                                cout<<endl<<PL("Micha≥ zapamiÍta to!")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                ...
                                SetConsoleTextAttribute(kolor, 4);
                                cout.width(50);
                                cout<<endl<<endl<<endl<<PL("Podszed≥eú do drzwi")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<endl<<PL("£apiesz za klamkÍ i prÛbujesz otworzyÊ.");
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<endl<<PL("Drzwi sπ zamkniÍte.");
                                SetConsoleTextAttribute(kolor, 2);
                                cout<<endl<<PL("Narrator: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Spodziewa≥eú siÍ czegoú innego debilu?")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 11);
                                cout<<endl<<"Co robisz?"<<endl;
                                ...
                                cout<<"1. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Wracasz przed drzwi do mieszkania Ali.")<<endl;
                                SetConsoleTextAttribute(kolor, 12);
                                cout<<"2. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Walisz w drzwi jak debil.")<<endl;
                                wyborgorzky9=getch();
                                switch(wyborgorzky9)
                                {
                                case '1'://wybÛr 4.1
                                ...
                                SetConsoleTextAttribute(kolor, 4);
                                cout.width(50);
                                cout<<endl<<endl<<endl<<PL("Walisz w drzwi jak debil")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 2);
                                cout<<endl<<PL("Narrator: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Kurwa, przestaÒ debilu chcesz zniszczyÊ drzwi?")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 11);
                                cout<<endl<<"Co robisz?"<<endl;
                                ...
                                cout<<"2. ";
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Walisz w drzwi jak debil dalej.")<<endl;
                                wyborgorzky10=getch();
                                switch(wyborgorzky10)
                                {
                                case '1'://wybÛr 4.2.1
                                    {
                                        powrotdrzwi();
                                ...
                                SetConsoleTextAttribute(kolor, 4);
                                cout.width(50);
                                cout<<endl<<endl<<endl<<PL("Walisz w drzwi jak debil dalej")<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 2);
                                cout<<endl<<PL("Narrator: ");
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<PL("Jeszcze raz dotkniesz kurwa tych drzwi to sam ciÍ wyúlÍ");
                                cout<<endl<<PL("          pod mieszkanie Ali.")<<endl<<endl;
                                SetConsoleTextAttribute(kolor, 8);
                                cout<<"--------------------------------------------------------------------------------";
                                SetConsoleTextAttribute(kolor, 11);
                                cout<<endl<<"Co robisz?"<<endl;
                                ...
                                cout<<PL("Walisz w drzwi jak debil dalej.")<<endl;
                                wyborgorzky11=getch();
                                switch(wyborgorzky11)
                                {
                                case '1'://wybÛr 4.2.2.1
                                {
                                    powrotdrzwi();
                                    goto przeddrzwi;
                                    break;
                                }
                                case '2'://wybÛr 4.2.2.2
                                    {
                                        powrotdrzwi();
                                        goto przeddrzwi;
                                        break;
